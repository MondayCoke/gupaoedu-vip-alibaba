package com.gupaoedu.gpmall.marking.markingserviceprovider.utils.exception;
 ...
 **/
@Slf4j
public class MmsExceptionWrapper implements Serializable{
    ...
    public static Exception handlerException4biz(AbstractResponse response, Exception e) {
        ...
        if (e instanceof BizException) {
            ...
            response.setCode(MmsResCodeEnum.SYSTEM_EXCEPTION.getCode());
            response.setMsg(MmsResCodeEnum.SYSTEM_EXCEPTION.getMsg());
        }
