...
-- ----------------------------
INSERT INTO `mms_lottery_chance` VALUES (1, 75, 3, 10, '2022-01-18 21:57:57');
...
INSERT INTO `mms_lottery_prize` VALUES (5, 1, '移动电源', 1, 40, 33, NULL);
...
INSERT INTO `mms_lottery_record` VALUES (16, '75', 6, '记事本', '2022-01-23 20:51:48');
INSERT INTO `mms_lottery_record` VALUES (17, '126', 5, '移动电源', '2022-01-23 20:54:13');
...
CREATE TABLE `tcc_account`  (
  ...
  `amount` double(50, 2) NULL DEFAULT NULL COMMENT '账号余额',
  `frozen_amount` double(50, 2) NULL DEFAULT 0.00 COMMENT '账号冻结余额',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tcc_account
-- ----------------------------
INSERT INTO `tcc_account` VALUES (1, 'tx-000001', 10000.00, 0.00);
...
) ENGINE = InnoDB AUTO_INCREMENT = 132 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = DYNAMIC;
