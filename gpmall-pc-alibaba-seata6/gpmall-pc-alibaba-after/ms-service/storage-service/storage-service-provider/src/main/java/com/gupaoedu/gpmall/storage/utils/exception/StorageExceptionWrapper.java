package com.gupaoedu.gpmall.storage.utils.exception;
 ...
 **/
@Slf4j
public class StorageExceptionWrapper implements Serializable{
    ...
    public static Exception handlerException4biz(AbstractResponse response, Exception e) {
        ...
        if (e instanceof BizException) {
            ...
            response.setCode(StorageResCodeEnum.SYSTEM_EXCEPTION.getCode());
            response.setMsg(StorageResCodeEnum.SYSTEM_EXCEPTION.getMsg());
        }
